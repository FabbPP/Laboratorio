...
public class Mapa {
    ...
    public Ejercito crearEjercito(int random, int numJugador,String nombreJ, String color) {
        String reino;
        if (numJugador == 1)
            reino = VentanaInicio.ReinoPlayer1;
        else 
            reino = VentanaInicio.ReinoPlayer2;
        Ejercito nuevoEjercito = new Ejercito(numJugador,new Reino(reino),color);
        ...
        for (int i = 0; i < nuevoEjercito.getCantidadSoldadosCrear(); i++) {
            ...
            int tipoSoldado = (int) (Math.random() * 5); // 0Caballero, 1Espadachin, 2Arquero, 3Lancero, 4Unidad Especial
            switch (tipoSoldado) {
                case 0:
                ...
                case 3:
                    ...
                    break;    
                default :{
                    switch (nuevoEjercito.getNombre()){
                        case "Inglaterra" :
                            nuevoSoldado = new EspadachinReal(nuevoEjercito);
                            break;
                        case "Francia" :
                            nuevoSoldado = new CaballeroFranco(nuevoEjercito);
                            break;
                        case "Sacro_imperio" :
                            nuevoSoldado = new EspadachinTeutonico(nuevoEjercito);
                            break;
                        case "Aragon_Castilla" :
                            nuevoSoldado = new EspadachinConquistador(nuevoEjercito);
                            break;
                        case "Moros" :
                            nuevoSoldado = new CaballeroMoro(nuevoEjercito);
                            break;
                        default :
                            nuevoSoldado = new Caballero(nuevoEjercito);
                    }
    ...
    public void movimientoTurnoEjercito(Ejercito ejercitoTurno, Ejercito ejercitoOtro){//Secundario generarMovimiento
        ...
        System.out.println("**Elija un soldado...");
