...
public class Videojuego20 {
    public static void main (String[] args){
        ...
        while(continuar){
            ...
            Ejercito ejercito1 = territorio.crearEjercito((int)(Math.random()*10) +1,1,VentanaInicio.nPlayer1,"rojo");
            Ejercito ejercito2 = territorio.crearEjercito((int)(Math.random()*10) +1,2,VentanaInicio.nPlayer2,"azul");
